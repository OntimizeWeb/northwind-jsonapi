...
resourcename="northwind.retool"  # lower case, only
resourcegroup="northwind.retool_rg"
...
# git clone https://github.com/apilogicserver/northwind.retool.git
# cd northwind.retool
...
az group create --name northwind.retool_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group northwind.retool_rg --sku S1 --is-linux
az container create --resource-group northwind.retool_rg --name northwind.retool --image apilogicserver/northwind.retool:latest --dns-name-label northwind.retool --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//northwind.retool.westus.azurecontainer.io:5656'
